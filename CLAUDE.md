...
**เริ่มทุก session: ตรวจว่ามีไฟล์ `HANDOFF_*.md` ที่ root ของ repo หรือไม่ ถ้ามีให้อ่านก่อนเริ่มงาน** เพราะในนั้นคืองานที่ค้างอยู่และการตัดสินใจที่จบไปแล้ว เมื่อทำงานใน handoff เสร็จหมดให้ลบไฟล์นั้นทิ้ง
